            ...
            <div class="col-md-5">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="<?php echo ($active == "details")? "active" : "" ?>"><a href="#details" data-toggle="tab">Details</a></li>
                        <li class="<?php echo ($active == "changepass")? "active" : "" ?>"><a href="#changepass" data-toggle="tab">Change Password</a></li>                        
                    </ul>
                    <div class="tab-content">
                        <div class="<?php echo ($active == "details")? "active" : "" ?> tab-pane" id="details">
                        ...
                        <div class="<?php echo ($active == "changepass")? "active" : "" ?> tab-pane" id="changepass">
