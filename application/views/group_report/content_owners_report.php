...
-->
<div class="jumbotron">
    <h3>Course ID Numbers / All Course Content Owners by Course Report</h3>
</div>
<hr>
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-sm table-responsive" id="myTable">
                ...
                <?php
                    $i=0;
                    foreach ($content_owners as $item)
                    {
                        echo "<tr>";
                        echo "<td>" . ++$i. "</td>";
...
<script language="javascript">
    $(document).ready(function(){
        var subtitle = "All Course Content Owners by Course Report";
        $('#myTable').DataTable({
            dom: 'lBfrtip',
            buttons: [{
                extend: 'csv',
